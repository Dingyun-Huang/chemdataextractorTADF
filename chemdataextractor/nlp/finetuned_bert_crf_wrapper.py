# BERT CRF TAGGER FROM https://raw.githubusercontent.com/allenai/scibert/master/scibert/models/bert_crf_tagger.py
...
class _BertCrfTagger(Model):
    ...
    def forward(self,  # type: ignore
        ...
        """
        print("\nallennlp indexer tokens:", tokens)
    ...
    def get_metrics(self, reset: bool = False) -> Dict[str, float]:
        """
        Get metrics for this model given its current state.
        """
        metrics_to_return = {}
