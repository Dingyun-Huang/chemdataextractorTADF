...
apparatus_blocklist = R('^(following|usual|equation|standard|accepted|method|point|temperature|melting|boiling)$', re.I)
apparatus_phrase = (W('with') | W('using') | W('on')).hide() + Optional(dt).hide() + Not(apparatus_blocklist) + apparatus
