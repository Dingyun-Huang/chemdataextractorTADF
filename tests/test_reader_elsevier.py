...
class TestElsXMLReader(unittest.TestCase):
    ...
    def test_direct_usage(self):
        ...
        f.close()
        self.assertEqual(len(d.elements), 131)
    ...
    def test_parse_table_rows(self):
        ...
        expected = [['1500', ['Tm (K)'], ['MD simulations with ReaxFF potential [73]']],
                    ['1750', ['Tm (K)'], ['MC simulations with ARK parameters [74]']],
                    ['1775', ['Tm (K)'], ['MD simulations with SW potential [42]']],
                    ['2.36\u202f×\u202f1011', ['γC (K/s)'], ['MD simulations with ReaxFF potential [73]']],
                    ['4.25\u202f×\u202f1011', ['γC (K/s)'], ['MC simulations with ARK parameters [74]']],
                    ['4.95\u202f×\u202f1011', ['γC (K/s)'], ['MD simulations with SW potential [42]']]]
